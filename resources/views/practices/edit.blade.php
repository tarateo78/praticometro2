...
<body>
    ...
    <form action="{{ route('practices.update', $practice->id) }}" method="POST">
        ...
        <input name="finanziamento" value="{{ old('finanziamento', $practice->finanziamento) }}" /><br>

        <label for="finanziamento_note">finanziamento_note</label>
        <input name="finanziamento_note" value="{{ old('finanziamento_note', $practice->finanziamento_note) }}" /><br>

        <label for="rup">rup</label>
        <input name="rup" value="{{ old('rup', $practice->rup) }}" /><br>

        <label for="fascicolo">fascicolo</label>
        <input name="fascicolo" value="{{ old('fascicolo', $practice->fascicolo) }}" /><br>
        ...
        <input name="rl_codice" value="{{ old('rl_codice', $practice->rl_codice) }}" /><br>

        <label for="mims_codice">mims_codice</label>
        <input name="mims_codice" value="{{ old('mims_codice', $practice->mims_codice) }}" /><br>
        ...
        <input name="progettista" value="{{ old('progettista', $practice->progettista) }}" /><br>

        <label for="sicurezza">sicurezza</label>
        <input name="sicurezza" value="{{ old('sicurezza', $practice->sicurezza) }}" /><br>

        <label for="file_count">file_count</label>
        <input name="file_count" value="{{ old('file_count', $practice->file_count) }}" /><br>
        ...
        <input name="fte_at" value="{{ old('fte_at', $practice->fte_at) }}" /><br>

        <label for="def_at">def_at</label>
        <input name="def_at" value="{{ old('def_at', $practice->def_at) }}" /><br>

        <label for="ese_at">ese_at</label>
        <input name="ese_at" value="{{ old('ese_at', $practice->ese_at) }}" /><br>

        <label for="cds_at">cds_at</label>
        <input name="cds_at" value="{{ old('cds_at', $practice->cds_at) }}" /><br>
        ...
        <input name="direttore_lavori" value="{{ old('direttore_lavori', $practice->direttore_lavori) }}" /><br>

        <label for="assistente_dl">assistente_dl</label>
        <input name="assistente_dl" value="{{ old('assistente_dl', $practice->assistente_dl) }}" /><br>

        <label for="consegna_lavori_at">consegna_lavori_at</label>
        <input name="consegna_lavori_at" value="{{ old('consegna_lavori_at', $practice->consegna_lavori_at) }}" /><br>

        <label for="impresa">impresa</label>
        <input name="impresa" value="{{ old('impresa', $practice->impresa) }}" /><br>
        ...
        <input name="rup_note" value="{{ old('rup_note', $practice->rup_note) }}" /><br>

        <label for="capitolo">capitolo</label>
        <input name="capitolo" value="{{ old('capitolo', $practice->capitolo) }}" /><br>

        <label for="urgente">urgente</label>
        <input name="urgente" value="{{ old('urgente', $practice->urgente) }}" /><br>

        <label for="urgente_nota">urgente_nota</label>
        <input name="urgente_nota" value="{{ old('urgente_nota', $practice->urgente_nota) }}" /><br>
        ...
        <input name="bdap" value="{{ old('bdap', $practice->bdap) }}" /><br>

        <label for="bdap_convalidato">bdap_convalidato</label>
        <input name="bdap_convalidato" value="{{ old('bdap_convalidato', $practice->bdap_convalidato) }}" /><br>

        <label for="bdap_note">bdap_note</label>
        <input name="bdap_note" value="{{ old('bdap_note', $practice->bdap_note) }}" /><br>

        <label for="sito_internet">sito_internet</label>
        <input name="sito_internet" value="{{ old('sito_internet', $practice->sito_internet) }}" /><br>

        <label for="sito_internet_nota">sito_internet_nota</label>
        <input name="sito_internet_nota" value="{{ old('sito_internet_nota', $practice->sito_internet_nota) }}" /><br>

        <label for="rif_llpp">rif_llpp</label>
        <input name="rif_llpp" value="{{ old('rif_llpp', $practice->rif_llpp) }}" /><br>

        <label for="determina_gruppo">determina_gruppo</label>
        <input name="determina_gruppo" value="{{ old('determina_gruppo', $practice->determina_gruppo) }}" /><br>

        <label for="check_at">check_at</label>
        <input name="check_at" value="{{ old('check_at', $practice->check_at) }}" /><br>

        <label for="modifica_at">modifica_at</label>
        <input name="modifica_at" value="{{ old('modifica_at', $practice->modifica_at) }}" /><br>

        <label for="modifica_utente">modifica_utente</label>
        <input name="modifica_utente" value="{{ old('modifica_utente', $practice->modifica_utente) }}" /><br>

        <label for="alias">alias</label>
        <input name="alias" value="{{ old('alias', $practice->alias) }}" /><br>

        <label for="scadenza_progetto">scadenza_progetto</label>
        <input name="scadenza_progetto" value="{{ old('scadenza_progetto', $practice->scadenza_progetto) }}" /><br>

        <label for="scadenza_affidamento">scadenza_affidamento</label>
        <input name="scadenza_affidamento"
            value="{{ old('scadenza_affidamento', $practice->scadenza_affidamento) }}" /><br>

        <label for="scadenza_esecutivo">scadenza_esecutivo</label>
        <input name="scadenza_esecutivo" value="{{ old('scadenza_esecutivo', $practice->scadenza_esecutivo) }}" /><br>

        <label for="gruppo">gruppo</label>
        <input name="gruppo" value="{{ old('gruppo', $practice->gruppo) }}" /><br>

        <label for="coordinate">coordinate</label>
        <input name="coordinate" value="{{ old('coordinate', $practice->coordinate) }}" /><br>

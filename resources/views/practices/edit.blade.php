...
<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('practices.update', $practice->id) }}" method="POST" class="main-form"
                    id="myForm">
    ...
    "" }} />
                            ...
                            <div class="flex w-full">
                                ...
                                <input name="titolo" id="titolo" class="flex-1"
                                    value="{{ old('titolo', $practice->titolo) }}" class="w-full" />
                            </div>
                            <div class="flex w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="">
                                <div class="flex w-full">
                                    ...
                                    <input name="fascicolo" id="fascicolo"
                                        value="{{ old('fascicolo', $practice->fascicolo) }}" class="flex-1" />
                                </div>

                                <div class="flex w-full">
                                    <label for="rup">RUP</label>
                                    <input name="rup" id="rup" class="flex-1"
                                        value="{{ old('rup', $practice->rup) }}" />
                                </div>
    ...
    $practice->pratica_note
                                ...
                                <input name="gruppo" id="gruppo" value="{{ old('gruppo', $practice->gruppo) }}"
                                    class="w-20" />
                                <br>

                                <label for="importo">Importo €</label>
                                <input name="importo" id="importo"
                                    value="{{ old('importo', number_format($practice->importo, 2, ",", ".")) }}"
                                    class="w-40" />
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="flex w-full">
                                    ...
                                    <input name="rl_codice" id="rl_codice"
                                        value="{{ old('rl_codice', $practice->rl_codice) }}" class="flex-1" />
                                </div>

    ...
    <div class="filtra">
        <div class="form">
            <form action="{{ route('practices.index') }}" method="GET">
                <label for="is_in_corso">Solo pratiche in corso</label><input type="checkbox" name="is_in_corso"
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('practices.edit', $practice) }}" class="link">{{ $practice->codice }}</a>
                </td>
                ...
                {{-- <td class="">{{ number_format((float)str_replace(str_replace($practice->importo,".",""),",",".") ,
                    2, "," , ".")}} €</td> --}}
